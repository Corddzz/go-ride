const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-neutral-950 via-slate-900 to-indigo-950 text-gray-300 py-12 px-4">
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="border-t border-gray-800 pt-6 text-center text-sm">
          <p>
            &copy; 2024 GoRide. All rights reserved. | Made by Cordz Designed
            with ❤️
          </p>
        </div>
      </div>
